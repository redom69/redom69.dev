...
Te doy mi opinión directa, sin filtros.

## **A corto y medio plazo, no nos reemplaza**

Y te explico por qué. La gente que realmente usa IA para programar son perfiles muy concretos — developers metidos en el mundillo, gente que sigue de cerca la tecnología. Una pyme normal, una empresa local pequeña, no tiene ni idea de qué es la IA aplicada al desarrollo. Si le propones un proyecto con IA te dice que sí, pero muchas veces es puro FOMO — acaban con un chatbot básico y pensando que eso es "hacer IA".

No es que la IA nos vaya a reemplazar. Es que a largo plazo las empresas no van a buscar menos gente — van a buscar una persona que saque el trabajo de tres, usando IA. Eso es lo que yo veo venir.
...
Meterse en el mundillo. No para depender de la IA, sino para saber usarla y no quedarse atrás. El que no la use va a competir contra el que saca el trabajo de tres.
